...
const SearchResults = ({ r, result, addedBooks, setAddedBooks }) => {
  // console.log(result.imageLinks && (result.imageLinks.smallThumbnail || "N/A"));
  console.log("search results, " + result.imagesLinks);
  console.log("con la r,", r.volumeInfo.imagesLinks);
  // console.log("result,", r);
  // console.log("hacer el notation aca,", r.volumeInfo);
