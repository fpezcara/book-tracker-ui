...
const bookNotInBookList = {
  ...
  "imageLinks": {
    "smallThumbnail": "http://books.google.com/books/content?id=xfHiDwAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api",
    "thumbnail": "http://books.google.com/books/content?id=xfHiDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
  },
  "language": "en",
  "previewLink": "http://books.google.co.uk/books?id=xfHiDwAAQBAJ&printsec=frontcover&dq=intitle:little+women&hl=&cd=5&source=gbs_api",
  "infoLink": "https://play.google.com/store/books/details?id=xfHiDwAAQBAJ&source=gbs_api",
  "canonicalVolumeLink": "https://play.google.com/store/books/details?id=xfHiDwAAQBAJ"
}
describe('usUniqueBook hook', () => {
  it('returns true when book is not in booklist', () => {
    const linkElement = useUniqueBook(bookList, bookList[0].books[0], 'reading');
